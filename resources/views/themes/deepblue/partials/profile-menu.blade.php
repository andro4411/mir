    ...
    <div class="dropdown account-dropdown">
        ...
        <div class="xs-dropdown-menu xs-dropdown-menu3 dropdown-menu dropdown-right">
            <div class="dropdown-content">
                ...
                <a class="dropdown-item" href="javascript:void(0)">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ml-15">
                            ...
                            <p> {{currencyPosition(auth()->user()->balance+0)}}</span></p>
                        </div>
                    </div>
                </a>
                ...
                <a class="dropdown-item"  href="javascript:void(0)">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body ml-15">
                            ...
                            <p> {{currencyPosition(auth()->user()->interest_balance+0)}}</span></p>
                        </div>
                    </div>
                </a>
                ...
                <form id="logout-form-submit" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
