...
<a class="das-nav nav-item {{menuActive(['user.fund.index'])}}"
...
<a class="das-nav nav-item {{menuActive(['user.transaction'])}}"
...
<a class="das-nav nav-item  {{menuActive(['user.payout'])}}"
...
<a class="das-nav nav-item  {{menuActive(['user.payout.index'])}}"
