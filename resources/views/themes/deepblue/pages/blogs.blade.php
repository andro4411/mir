            ...
            <div class="d-flex justify-content-center">
                <div class="col-lg-6">
                    <div class="heading-container">
                        <h6 class="topheading">{!! $blog['single']['heading']??'' !!}</h6>
                        <h3 class="heading">{!! $blog['single']['sub_heading']??'' !!}</h3>
                        <p class="slogan">{!! $blog['single']['short_details']??'' !!}</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <a class="card-blog card wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.15s"
                               href="{{route('blog.details',optional($data->details)->slug??'blog-details')}}">
                                ...
                                <p class="text">
                                    {{strip_tags(Illuminate\Support\Str::limit(strip_tags(optional($data->details)->description),120))}}
                                </p>
