            ...
            @foreach($plans as $k => $data)
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-box" data-aos="fade-up" data-aos-duration="800"
                        ...
                        @else
                            <h5>{{trans(basicControl()->currency_symbol)}}{{getAmount($data->profit)}} @lang('Every') {{trans($getTime->name)}}</h5>
                        @endif
                        ...
                        <button class="btn-custom investNow" type="button"
                                 data-price="{{$data->price}}" data-resource="{{$data}}">
                            @lang('Invest Now')
                        </button>
                    </div>
                </div>
