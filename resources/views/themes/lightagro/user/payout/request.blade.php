                ...
                <div class="col-12 payout_alert" >
                    <div class="bd-callout bd-callout-warning alert d-flex justify-content-between align-items-start bg-white" role="alert">
                        <div class="d-flex align-items-center">
                            <i class="fal fa-info-circle me-2"></i> <h5 class="mb-0">{{ __('Today Withdraw feature is off. Please try on one of these days:') }}
            ...
            <div class="checkout-section">
                <div class="card p-4 padding-payout">
                    <form action="{{ route('user.payout.request') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal fade paymentModal" id="staticBackdrop" tabindex="-1" aria-labelledby="investModalLabel" aria-hidden="true" data-bs-backdrop="static">
