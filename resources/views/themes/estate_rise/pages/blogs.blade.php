    ...
    <section class="blog-section">
        <div class="container">
            <div class="row align-items-center text-center text-md-start">
                <div class="col-md-6">
                    <div class="section-subtitle" data-aos="fade-up" data-aos-duration="500">{!! $blog['single']['heading']??'' !!}</div>
                    <h2 data-aos="fade-up" data-aos-duration="700">{!! $blog['single']['sub_heading']??'' !!}</h2>
                </div>
