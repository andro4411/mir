                    ...
                    <table class="table table-striped">
                        ...
                        @forelse ($plans as $key => $plan)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn-custom d-flex justify-content-center align-items-center investNow" href="javascript:void(0)"  data-price="{{$plan->price}}" data-resource="{{$plan}}"><i class="fal fa-usd-circle" aria-hidden="true"></i> @lang('Invest') </a>
                                </td>
                            </tr>
                        @empty
                    ...
                    <form class="login-form" id="invest-form" action="{{route('user.purchase-plan')}}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group mb-3">
                                <div class="box">
                                    <h6 class="form-label">@lang('Select wallet')</h6>
                                    <select class="form-select mb-3 cutom__referal_input__group" aria-label="@lang('Default select example')" name="balance_type">
                                        @auth
                                            <option
                            ...
                            <div class="form-group mb-3">
                                <div class="box">
                                    ...
                                    <div class="input-group mb-3 cutom__referal_input__group">
                                        ...
                                        <button class="input-group-text btn-custom copy__referal_btn copytext  show-currency"></button>
                                    </div>
                                </div>
                            </div>
