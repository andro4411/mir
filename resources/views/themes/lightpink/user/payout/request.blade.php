        ...
        <div class="main row">
            @if(!isActivePayout())
                <div class="col-12 payout_alert">
                    <div
                        class="bd-callout bd-callout-primary alert d-flex justify-content-between align-items-center bg-white"
                        role="alert">
                        ...
                        <button class="close-btn pt-1"><i class="fal fa-times"></i>
                        </button>
                    </div>
                </div>
            @endif
                ...
                <div class="mt-3 checkout-section">
                    <div class="card  padding-payout">
                        <form action="{{ route('user.payout.request') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal fade paymentModal" id="staticBackdrop" tabindex="-1"
                                 aria-labelledby="investModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div id="payoutSummary">
        <div class="row d-flex text-center justify-content-center">
            ...
            function showCharge(response, currency) {
               ...
               <button type="submit" class="btn btn-custom">@lang('Withdraw')</button>`;
