                ...
                <div class="checkout-section">
                    <div class="card p-4  padding">
                        <form action="{{ route('payment.request') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal fade" id="staticBackdrop" tabindex="-1" aria-labelledby="investModalLabel" aria-hidden="true" data-bs-backdrop="static">
    ...
    <div id="paymentSummary">
        <div class="row d-flex text-center justify-content-center">
            ...
            function showCharge(response, currency) {
                ...
                <button type="submit" class="btn btn-primary base-btn btn-block btn-rounded">@lang('Make Payment') <span></span> </button>`
                ;
