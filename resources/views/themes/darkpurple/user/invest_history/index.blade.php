                        ...
                        @forelse ($investments as $key => $invest)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge  bg-danger">@lang('Terminated')</span>
                                    @endif
                                </td>
                                @if(basicControl()->user_termination)
                                    <td>
                                        @if($invest->status == 1)
                                            <button type="button" data-bs-toggle="modal" data-route="{{route('user.terminate',$invest->id)}}" data-bs-target="#TerminateModal" class="btn-custom terminateBtn">@lang('Terminate')</button>
            ...
            <div class="modal-content">
                ...
                <form id="terminateRoute" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn-custom">@lang("Confirm")</button>
                    </div>
                </form>
            </div>
        </div>
