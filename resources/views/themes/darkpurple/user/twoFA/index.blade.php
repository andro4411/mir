                    ...
                    @if(auth()->user()->two_fa == 1)
                        <div class="col-lg-6 col-md-6 mb-3">
                            <div class="card text-center">
                                ...
                                <div class="bg-transparent mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="refferal-box">
                                        <div class="input-group mb-3 cutom__referal_input__group">
                                            <input type="text" class="form-control copy__referal__input" value="{{$secret}}"
                                                   id="referralURL" readonly>
                                            <button class="input-group-text btn-custom copy__referal__btn copytext"
                                                    id="copyBoard"
