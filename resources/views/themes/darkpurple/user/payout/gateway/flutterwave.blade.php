                                ...
                                <form action="">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span
                                                class="text-white">{{ (getAmount($payout->amount)) }} {{ $payout->payout_currency_code }}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span>@lang('Charge')</span>
                                            <span
                                                class="text-white">{{ (getAmount($payout->charge)) }} {{ $payout->payout_currency_code }}</span>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span>@lang('Charge Percentage')</span>
                                            <span
                                                class="text-white">{{ (getAmount($payout->net_amount)) }} {{ $payout->payout_currency_code }}</span>
                                        </li>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            ...
                                            <span
                                                class="text-white">{{ (getAmount($payout->net_amount_in_base_currency)) }} {{ $basic->base_currency }}</span>
                                        </li>
    ...
    <script type="text/javascript">
        ...
        function showInputForm(form_fields) {
            ...
            for (let field in form_fields) {
                ...
                output += `<div class="col-md-6 input-box mt-3">
