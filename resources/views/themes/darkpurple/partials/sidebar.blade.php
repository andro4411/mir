<div id="sidebar" class="">
    ...
    <ul class="main tabScroll">
        ...
        <li>
            <a href="{{route('user.plan')}}" class="sidebar-link {{menuActive(['user.plan'])}}">
        ...
        <li>
            <a href="{{route('user.fund.index')}}" class="sidebar-link {{menuActive(['user.fund.index'])}}">
        ...
        <li>
            <a href="{{route('user.payout')}}" class="sidebar-link {{menuActive(['user.payout'])}}">
                <i class="fal fa-hand-holding-usd"></i> @lang('payout')
            </a>
        </li>
        <li>
            <a href="{{route('user.payout.index')}}" class="sidebar-link {{menuActive(['user.payout.index'])}}">
        ...
        <li class="">
            <a href="{{route('user.referral.bonus')}}" class="sidebar-link {{menuActive(['user.referral.bonus'])}}">
