    ...
    <div class="container-fluid">
        <div class="main row">
            ...
            <div class="checkout-section">
                <div class="card p-4  padding bg-white">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-md">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="investModalLabel">@lang('Deposit')</h4>
    ...
    <div id="paymentSummary">
        <div class="row d-flex text-center justify-content-center">
            ...
            function showCharge(response, currency) {
                ...
                <button type="submit" class="btn btn-custom">@lang('Make Payment') <span></span> </button>`
                ;
