                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        @elseif($item->status == 2)
                                            <span class="badge rounded-pill bg-success">@lang('Complete')</span>
                                        @elseif($item->status == 3)
                                            <span class="badge rounded-pill bg-danger">@lang('Cancel')</span>
                                        @endif
                                </td>
                                ...
                                <td>
                                    @if($item->status == 0)
                                        <a href="{{ route('user.payout.confirm',$item->trx_id) }}" target="_blank"
                                           class="btn btn-primary"><i class="fas fa-check-circle"></i> @lang('Confirm') <span></span></a>
                                    @else
                                        <button
                                            type="button"
