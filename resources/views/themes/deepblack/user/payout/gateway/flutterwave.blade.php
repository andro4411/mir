                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <form action="{{ route('user.payout.flutterwave',$payout->trx_id) }}"
                                      method="post"
                                      enctype="multipart/form-data" class="form-row  preview-form">
                                    @csrf
                                            ...
                                            <div class="col-md-12 input-box mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="from_wallet" name="transfer_name"
                                                            class="form-control bg-transparent form-control-sm bank">
        ...
        function showInputForm(form_fields) {
            ...
            for (let field in form_fields) {
                ...
                output += `<div class="col-md-6 mt-3">
				         ...
				         <input type="text" name="${field}" value="" class="form-control bg-transparent" required>
			          </div>`
            }
