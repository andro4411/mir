                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <div class="card text-center">
                                ...
                                <div class="card-header bg-white mb-3 d-flex justify-content-between align-items-center">
                                    <h4 class="mb-2 golden-text">@lang("Two Factor Authenticator")</h4>
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#regenerateModal"
                                            class="gold-btn">@lang("Regenerate")</button>
                                </div>
                                <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <form action="{{route('user.twoStepRegenerate')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-bg">@lang('Yes')</button>
                    </div>
                </form>
            </div>
        </div>
