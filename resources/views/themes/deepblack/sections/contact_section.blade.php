        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="header-text-full mb-5">
                    <h2>{!! $contact_section['single']['heading']??'' !!}</h2>
                ...
                <div class="contact-box">
                    <form action="{{route('contact.send')}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="input-group mb-4">
                                <div class="img">
                                    <img src="{{asset(template(true).'img/icon/email2.png')}}" alt="@lang('edit img')" />
                                </div>
                                <input
                                    type="email"
                                    name="email"
                        ...
                        <div>
                            ...
                            <div class="input-group mb-4">
                                <div class="img">
                                    <img src="{{asset(template(true).'img/icon/edit.png')}}" alt="" />
                                </div>
                                <textarea
                                    class="form-control"
                                    name="message"
