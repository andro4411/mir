                ...
                <div aria-label="@lang('breadcrumb')">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)"
                                                       class="cursor-inherit">{{trans('Ticket: #'.$ticket->ticket)}}</a></li>
                    </ol>
                </div>
            </div>
        </section>
            ...
            <div class="modal-content form-block">
                ...
                <form method="post" action="{{route('user.ticket.close',$ticket->id)}}">
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="close close-button close_btn" data-dismiss="modal">&times;</button>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-light close_btn" id="close_btn">
                            @lang('Close')
                        </button>

                        <button type="submit" class="btn btn-primary base-btn"
                                >@lang("Confirm")
                        </button>
                    </div>
