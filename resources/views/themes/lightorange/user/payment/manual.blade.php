            ...
            <div aria-label="@lang('breadcrumb')">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)"
                                                   class="cursor-inherit">{{ trans('Pay with').' '.optional($deposit->gateway)->name ?? '' }}</a></li>
                </ol>
            </div>
        </div>
    </section>
                ...
                <div class="feature-box">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('addFund.fromSubmit',$deposit->trx_id)}}" method="post"
                            ...
                            <div class="col-md-12 ">
                                <div class=" form-group">
                                    <button type="submit" class="btn btn-primary base-btn btn-block btn-rounded w-100 mt-3">
