...
@section('content')
                    ...
                    <div class="col-lg-6 col-md-6 mb-3">
                        <div class="card card-type-1 text-center br-4">
                            <div class="card-header mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <a href="javascript:void(0)"  class="btn btn-sm btn-danger ml-4"
                                   data-toggle="modal" data-target="#regenerateModal">@lang('Regenerate')</a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content form-block">
                <div class="modal-header">
                    ...
                    <button type="button" class="close close_btn" data-id="enableModal" data-dismiss="modal">&times;</button>
                ...
                <form action="{{route('user.twoStepEnable')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark close_btn" data-id="enableModal" data-dismiss="modal">@lang('Close')</button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content form-block">
                <div class="modal-header">
                    ...
                    <button type="button" class="close close_btn" data-id="disableModal" data-dismiss="modal">&times;</button>
                </div>
                <form action="{{route('user.twoStepDisable')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark close_btn" data-id="disableModal" data-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-success">@lang('Verify')</button>
                    </div>
                </form>
            </div>
    ...
    <!--Disable Modal -->
    <div id="regenerateModal" class="modal fade" role="dialog">
        <div class="modal-dialog">

            <!-- Modal content-->
            <div class="modal-content form-block">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Re-generate Confirmation')</h5>
                    <button type="button" class="close close_btn" data-id="regenerateModal" data-dismiss="modal">&times;</button>
                </div>
                <form action="{{route('user.twoStepRegenerate')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark close_btn" data-id="regenerateModal" data-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-success">@lang('Verify')</button>
                    </div>
                </form>
            </div>
