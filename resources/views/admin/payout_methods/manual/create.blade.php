...
@section('page_title', __('Add Withdraw Method'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="@lang('breadcrumb')">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Add Withdraw Method')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Add Withdraw Method')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('Add Withdraw Method')</h3>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{route('admin.payout.method.store')}}" method="post"
                                ...
                                <div class="row mb-4 d-flex align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span class="col-4 col-sm-9 ms-0 ">
                                          <span class="d-block text-dark">@lang("Manual Withdraw Status")</span>
                                          <span
                                              class="d-block fs-5">@lang("Enable manual withdraw status as active for the transaction.")</span>
                                        </span>
                                    ...
                                    <div class="col-sm-9">
                                        <div>
                                            <label class="form-label"
                                                   for="descriptionLabel">@lang('Description')</label>
                                            <textarea id="exampleFormControlTextarea1" name="description" class="form-control" placeholder="@lang("Description")" rows="4">{{ old("description") }}</textarea>
                                        </div>
                                        @error('description')
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="card supported_currency_card">
                                    ...
                                    <div class="table-responsive position-relative">
                                        <table
                                            class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table supported_currency_table">
                                            <thead class="thead-light">
                                            <tr>
                                            ...
                                            @php
                                                $oldPayoutsCount = old('payout_currencies') ? count(old('payout_currencies')) : 0;
                                            @endphp

                                            @if($oldPayoutsCount > 0)
                                                @for($i = 0; $i < $oldPayoutsCount; $i++)
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control change_currency"
                                                                   ...
                                                                   value="{{ old("payout_currencies.$i.currency_symbol") }}"
                                                                   autocomplete="off">
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ old("payout_currencies.$i.conversion_rate") }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text set-currency">{{ old("payout_currencies.$i.currency") }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ old("payout_currencies.$i.min_limit") }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text set-currency">{{ old("payout_currencies.$i.currency") }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ old("payout_currencies.$i.max_limit") }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text set-currency">{{ old("payout_currencies.$i.currency") }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ old("payout_currencies.$i.percentage_charge") }}"
                                                                       autocomplete="off">
                                                                <span
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ old("payout_currencies.$i.fixed_charge") }}"
                                                                       autocomplete="off">
                                                                <span class="input-group-text set-currency">{{ old("payout_currencies.$i.currency") }}</span>
                                            ...
                                            @else
                                                <tr>
                                                    <td>
                                                        <input type="hidden" name="payout_currenciesFields[]" value="0">
                                                        <input type="text" class="form-control change_currency mb-1"
                                                               name="payout_currencies[0][currency_symbol]"
                                                               placeholder="@lang("Currency")"
                                                               aria-label="@lang("Currency")"
                                                               value="{{ old("payout_currencies.0.currency_symbol") }}"
                                                               autocomplete="off">
                                                        @error("payout_currencies.0.currency_symbol")
                                                        <span
                                                            class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                        @enderror
                                                    </td>
                                                    <td>
                                                        <div class="input-group mb-1">
                                                            ...
                                                            <input type="text"
                                                                   class="form-control @error('conversion_rate') is-invalid @enderror"
                                                                   name="payout_currencies[0][conversion_rate]"
                                                                   value="{{ old("payout_currencies.0.currency") }}"
                                                                   autocomplete="off">
                                                            <span
                                                                class="input-group-text set-currency">{{ old('payout_currencies.0.currency') }}</span>
                                                            @error("payout_currencies.0.conversion_rate")
                                                            <span
                                                                class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-1">
                                                            <input type="text"
                                                                   class="form-control @error('min_limit') is-invalid @enderror"
                                                                   name="payout_currencies[0][min_limit]"
                                                                   value="{{ old('payout_currencies.0.min_limit') }}"
                                                                   autocomplete="off">
                                                            <span
                                                                class="input-group-text set-currency">{{ old('payout_currencies.0.currency') }}</span>
                                                            @error('payout_currencies.0.min_limit')
                                                            <span
                                                                class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-1">
                                                            <input type="text"
                                                                   class="form-control @error('max_limit') is-invalid @enderror"
                                                                   name="payout_currencies[0][max_limit]"
                                                                   value="{{ old('payout_currencies.0.max_limit') }}"
                                                                   autocomplete="off">
                                                            <span
                                                                class="input-group-text set-currency">{{ old('payout_currencies.0.currency') }}</span>
                                                            @error('payout_currencies.0.max_limit')
                                                            <span
                                                                class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-1">
                                                            <input type="text"
                                                                   class="form-control @error('percentage_charge') is-invalid @enderror"
                                                                   name="payout_currencies[0][percentage_charge]"
                                                                   value="{{ old('payout_currencies.0.percentage_charge') }}"
                                                                   autocomplete="off">
                                                            <span
                                                                class="input-group-text">%</span>
                                                            @error('payout_currencies.0.percentage_charge')
                                                            <span
                                                                class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-1">
                                                            <input type="text"
                                                                   class="form-control @error('fixed_charge') is-invalid @enderror"
                                                                   name="payout_currencies[0][fixed_charge]"
                                                                   value="{{ old('payout_currencies.0.fixed_charge') }}"
                                                                   autocomplete="off">
                                                            <span
                                                                class="input-group-text set-currency">{{ old('payout_currencies.0.currency') }}</span>
                                                            @error('payout_currencies.0.fixed_charge')
                                                            <span
                                                                class="invalid-feedback d-block mb-1">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    </td>
                                                    <td class="table-column-ps-0 mb-1">
                                                        <button type="button" class="btn btn-white remove-row">
                                                            <i class="bi-trash"></i>
                                                        </button>
                                                    </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.remove-row', function (e) {
                ...
                supported_currency_tableTrLen();

            });

            function supported_currency_tableTrLen() {
                                ...
                                <input type="hidden" name="payout_currenciesFields[]" value="${rowCount}">
                                   ...
                                   <td>
                                        <div class="input-group mb-1">
                                            ...
                                            <input type="text"
                                                   class="form-control"
                                                   name="payout_currencies[${rowCount}][conversion_rate]"
                                                   autocomplete="off">
                                     ...
                                     <td>
                                         <div class="input-group mb-1">
                                             <input type="text"
                                                   class="form-control"
                                                   name="payout_currencies[${rowCount}][min_limit]"
                                                   autocomplete="off">
                                                   <span class="input-group-text set-currency"></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group mb-1">
                                            <input type="text"
                                                   class="form-control"
                                                   name="payout_currencies[${rowCount}][max_limit]"
                                                   autocomplete="off">
                                            <span class="input-group-text set-currency"></span>
                                        </div>
                                        </td>
                                        <td>
                                            <div class="input-group mb-1">
                                                <input type="text"
                                                   class="form-control"
                                                   name="payout_currencies[${rowCount}][percentage_charge]"
                                                   autocomplete="off">
                                        ...
                                        <td>
                                            <div class="input-group mb-1">
                                                <input type="text"
                                                       class="form-control"
                                                   name="payout_currencies[${rowCount}][fixed_charge]"
                                                   autocomplete="off">
                                                <span class="input-group-text set-currency"></span>
                                            </div>
                                        </td>
