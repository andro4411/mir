...
@section('content')
    ...
    <div class="content container-fluid dashboard-height">
        <div id="firebase-app">
            <div class="shadow p-3 mb-5 alert-soft-dark mb-4 mb-lg-7" role="alert"
            ...
            <div class="col-lg-4 mb-3 mb-lg-5">
                <div class="d-grid gap-2 gap-lg-4">
                    @if(adminAccessRoute(config('role.manage_plan.access.add')))
                        <!-- Card -->
                        <a class="card card-hover-shadow" href="{{route('admin.plan.create')}}">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-grow-1 ms-4">
                                        <h3 class="text-inherit mb-1">@lang('Investment Plan')</h3>
                    ...
                    @if(adminAccessRoute(config('role.schedule.access.view')))
                        <!-- Card -->
                        <a class="card card-hover-shadow" href="{{route('admin.schedule')}}">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="flex-grow-1 ms-4">
                                        <h3 class="text-inherit mb-1">@lang('Schedule')</h3>
                                        <span class="text-body">@lang('Manage Schedule')</span>
                                    </div>
            ...
            <div class="col-lg-8 mb-3 mb-lg-5">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-header card-header-content-between">
                        <h4 class="card-header-title">@lang('Top Investment Plan')</h4>

                        <a class="btn btn-ghost-secondary btn-sm" href="{{route('admin.plan')}}">@lang('View all')</a>
                    </div>
                    <!-- End Header -->
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{route('admin.plan.edit',$plan->id)}}">
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="text-inherit mb-0">{{$plan->name}}</h5>
                                                </div>
                                            </a>
                                            <!-- End Media -->
                                        </td>
                                        <td> {{$plan->price}}</td>
                                        <td> {{count($plan->investment??[])}} <i><sub>(times)</sub></i></td>
                                        <td>{{currencyPosition($plan->investment_sum_amount+0)}}</td>
                                    </tr>
                                @endforeach
                ...
                <table class="table table-borderless table-thead-bordered table-align-middle card-table">
                    ...
                    @forelse($latestUser as $user)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    {{ currencyPosition($user->balance+0) }}
                                </div>
                            </td>
                            <td>
                                {{ currencyPosition($user->interest_balance+0) }}
                            </td>
                            <td>
                                {{ currencyPosition($user->total_invest+0) }}
                            </td>
                            <td>
                                @if($user->status == 1)
