                        ...
                        <label class="form-control" for="editUserModalBalanceTypeModalRadioEg1_2">
                            <span class="form-check">
                              <input type="radio" class="form-check-input" name="balance_type"
                                     id="editUserModalBalanceTypeModalRadioEg1_2" value="1" checked>
                              <span class="form-check-label"> @lang("Balance")</span>
                            </span>
                        </label>

                        <label class="form-control" for="editUserModalBalanceTypeModalRadioEg1_1">
                        <span class="form-check">
                          <input type="radio" class="form-check-input" name="balance_type"
                                 id="editUserModalBalanceTypeModalRadioEg1_1" value="0">
