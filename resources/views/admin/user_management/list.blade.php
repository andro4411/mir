...
@section('content')
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="@lang('Search users')"
                               aria-label="@lang('Search users')" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    <div id="datatableCounterInfo">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-outline-success ms-2 btn-sm exportBtn" href="javascript:void(0)" data-bs-toggle="modal"
                               data-bs-target="#downloadUserDetails">
    ...
    <!-- Modal -->
    <div class="modal fade" id="downloadUserDetails" tabindex="-1" role="dialog" aria-labelledby="downloadUserDetailsModalLabel" data-bs-backdrop="static"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="downloadUserDetailsModalLabel"><i
                ...
                <form action="{{route('admin.user.details.export')}}" method="get">
                    <div class="modal-body">
                        @lang('Do you want to download user details?')
        ...
        $(document).on('ready', function () {
            ...
            $(document).on('click','.exportBtn',function (){
                ...
                strIds.forEach((value,index)=>{
                    inputField += `<input type="hidden" name="user_ids[]" value="${value}">`
                })
