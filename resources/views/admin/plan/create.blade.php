                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{old('name')}}" name="name" id="planName" placeholder="@lang('e.g : basic plan')">
                                        @error("name")
                                ...
                                <div class="col-md-6" id="plan_period_fixed">
                                    ...
                                    ></i>
                                    <div class=" mb-4">
                                        <input type="text" name="badge" value="{{old('badge')}}" id="badge" class="form-control @error('badge') is-invalid @enderror" placeholder="@lang('e.g : premium , popular')">
                                        @error("badge")
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6" id="minimum_invest_field">
                                    ...
                                    <div class="input-group mb-4">
                                        <input type="number" class="form-control @error('minimum_amount') is-invalid @enderror" value="{{old('minimum_amount')}}" id="minimum_invest" name="minimum_amount" placeholder="@lang('e.g : 2000')" step="0.01">
                                ...
                                <div class="col-md-6" id="maximum_invest_field">
                                    ...
                                    <div class="input-group mb-4">
                                        <input type="text" class="form-control @error('maximum_amount') is-invalid @enderror" value="{{old('maximum_amount')}}" id="minimum_invest" name="maximum_amount" placeholder="@lang('e.g : 5000')">
                                        <span class="input-group-text" id="priceCurrency">{{basicControl()->currency_symbol}}</span>
                                ...
                                <div class="col-md-6" id="fixed_invest_amount">
                                    ...
                                    <div class="input-group mb-4">
                                        <input type="number" class="form-control @error('fixed_amount') is-invalid @enderror" value="{{old('fixed_amount')}}" id="plan_price" name="fixed_amount" placeholder="@lang('e.g : 8000')" step="0.01">
                                        <span class="input-group-text" id="priceCurrency">{{basicControl()->currency_symbol}}</span>
                                        @error("fixed_amount")
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    ></i>
                                    <div class="input-group mb-4">
                                        <input type="number" class="form-control @error('profit') is-invalid @enderror" id="return_period" value="{{old('profit')}}" name="profit" placeholder="@lang('e.g : 5.00')" step="0.001">
                                ...
                                <div class="col-md-6" id="Maturity">
                                    ...
                                    ></i>
                                    <div class="input-group mb-4">
                                        <input type="number" name="repeatable"   value="{{old('repeatable')}}"  class="form-control @error('repeatable') is-invalid @enderror" placeholder="@lang('e.g : 50')">
                                        <!-- Select -->
