    ...
    <div class="content container-fluid">
        ...
        <div class="card" id="test">
            <div class="card-header card-header-content-between">
                ...
                @if(adminAccessRoute(config('role.role_management.access.add')))
                    <a class="btn btn-primary" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#AddRoleModal"> <i class="fa-duotone fa-solid fa-plus me-1"></i> @lang('Add New')</a>
                @endif
...
@push('script')
    <script>
        ...
        $('.select-all-access').on('click', '.selectAll', function () {
            if ($(this).is(':checked')) {
