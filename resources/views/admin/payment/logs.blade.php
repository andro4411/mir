...
@section('content')
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    <div id="datatableCounterInfo">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-outline-success btn-sm exportBtn" href="javascript:void(0)" data-bs-toggle="modal"
                               data-bs-target="#downloadDepositDetails">
    ...
    <!-- Modal -->
    <div class="modal fade" id="downloadDepositDetails" tabindex="-1" role="dialog" aria-labelledby="downloadDepositDetailsModalLabel" data-bs-backdrop="static"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="downloadDepositDetailsModalLabel"><i
                            class="fa-light fa-square-check"></i> @lang('Confirmation')</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="@lang('Close')"></button>
                </div>
                <form action="{{route('admin.export.payment.details')}}" method="get">
                    <div class="modal-body">
                        @lang('Do you want to download payment details?')
        ...
        $(document).on('ready', function () {
            ...
            $(document).on('click','.exportBtn',function (){
                ...
                strIds.forEach((value,index)=>{
                    inputField += `<input type="hidden" name="deposit_ids[]" value="${value}">`
                })
