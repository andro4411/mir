                            ...
                            <div
                                ...
                                <div class="list-group-item mb-2">
                                    <div class="d-flex justify-content-between align-items-center drop-content">
                                        ...
                                        <i class="fa-light"></i>
                                        @if($page->type == 3)
                                            @if(adminAccessRoute(config('role.manage_menu.access.edit')) || adminAccessRoute(config('role.manage_menu.access.delete')))
                                                <div class="dropdown">
                                                    <button type="button"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end mt-1"
                                                        ...
                                                        @endif
                                                        @if(adminAccessRoute(config('role.manage_menu.access.delete')))
