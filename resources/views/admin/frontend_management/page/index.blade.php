        ...
        <div class="alert alert-soft-dark" role="alert">
            <div class="d-sm-flex">
                ...
                <div class="flex-grow-1 ms-sm-4" id="control-panel-notice">
                    ...
                    If you wish to change the <a href="{{route('admin.theme')}}">theme</a> , please navigate to the Themes section to select or customize a new look for your site.
                ...
                <div class="d-grid gap-3 gap-lg-3">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            @if(adminAccessRoute(config('role.pages.access.add')))
                                ...
                                <table class="table table-thead-bordered table-nowrap table-align-middle card-table">
                                    ...
                                    @forelse($allPages as $page)
                                        <tr>
                                            ...
                                            <td>
                                                {{stringToTitle($page->template_name)}}
                                            </td>
                                            ...
                                            <td class="text-center">
                                                @if(adminAccessRoute(config('role.pages.access.edit')))
                                                    @if($page->type !== 1)
                                                        @foreach($allLanguage as $language)
                                            ...
                                            <td>
                                                @if(adminAccessRoute(config('role.pages.access.edit')) && adminAccessRoute(config('role.pages.access.delete')))
                                                ...
                                                @elseif(adminAccessRoute(config('role.pages.access.edit')))
                                                    <a class="btn btn-white btn-sm"
                                                       href="{{ route('admin.edit.page', [$page->id, $theme, $defaultLanguage->id]) }}">
                                                        <i class="bi-pencil-fill me-1"></i> @lang("Edit")
                                                    </a>
                                                @elseif(adminAccessRoute(config('role.pages.access.delete')))
                                                    <a class="btn btn-white btn-sm deleteBtn text-danger"
                                                       href="javascript:void(0)"
                                                       data-pagename="{{ optional($page->details)->name }}"
                                                       data-route="{{ route("admin.page.delete", $page->id) }}"
