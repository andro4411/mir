...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="alert alert-soft-dark mb-5" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex align-items-center">
                        <p class="mb-0">@lang("You are editing static `$page->name` page for `$pageEditableLanguage->name` version in `".stringToTitle(getTheme())."`")</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route("admin.update.static.page", [$page->id, getTheme()]) }}" method="post"
