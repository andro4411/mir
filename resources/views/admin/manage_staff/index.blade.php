        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang("Staff List")</h1>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="test">
            <div class="card-header card-header-content-between">
               ...
               @if(adminAccessRoute(config('role.manage_staff.access.add')))
                    <a class="btn btn-primary" href="{{route('admin.staff.create')}}" > <i class="fa-duotone fa-solid fa-plus me-1"></i> @lang('Add New')</a>
               @endif
