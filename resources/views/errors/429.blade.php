...
<head>
    ...
    <title>@lang(basicControl()->site_title??"HYIP PRO") | @lang('Session Expired')</title>
    <!-- Favicon-link -->
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-sm-6">
                <div class="error-content">
                    ...
                    <div class="error-info">@lang('Slow Down')!</div>
                    <p>
                        @lang('Looks like you’re sending a few too many requests too quickly. Please take a moment before trying again.We’re here to help, so if you think this is a mistake, feel free to contact us for assistance.')
                    </p>
                    <div class="btn-area">
