...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->decimal('interest_balance', 11, 2)->nullable();
            $table->decimal('total_invest', 11, 2)->nullable();
            $table->decimal('total_deposit', 11, 2)->nullable();
            $table->decimal('total_interest_balance', 11, 2)->nullable();
            $table->decimal('admin_update_badge', 11)->nullable();
            $table->string('last_lavel',191)->nullable();
