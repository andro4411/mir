...
return [
    'settings' => [
        ...
        'GDPR Cookie' => [
            ...
            'short_description' => 'Cookie such as, cookie title, cookie image, text, status,cookie button and so on.',
        ],
        'App Setting' => [
            'route' => 'admin.app.settings',
            'icon' => 'fa-thin fa-screwdriver-wrench',
            'short_description' => 'App Settings such as, App base color, App version, App build and so on.',
        ],
        'logo' => [
